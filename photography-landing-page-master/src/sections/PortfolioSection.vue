	...
	<section id="portfolio-section" class="px-4 lg:px-8 py-16  relative">
        ...
        <div class="flex gap-8 flex-col md:flex-row">
            ...
            <p class="capitalize xl:w-1/2 text-stone-500 mb-8">
                Improving the overall healthcare experience for doctors, patients, and pharmacies by enabling them to communicate more effectively and efficiently. The application aims to provide a centralized platform where doctors, patients, and pharmacies can connect and share information, improving the quality of care and enhancing the patient experience.
            </p>
            <!-- Main text end -->
        </div>
        <!-- Text wrapper end -->
